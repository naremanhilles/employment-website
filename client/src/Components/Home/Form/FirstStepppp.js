  ...
  render() {
    ...
    return (
      <FormAnt onSubmit={this.validateInput} layout="vertical">
        ...
        */}
        <FormAnt className="add-captain__form">
          <div className="add-captain-container-left">
            <FormAnt.Item label="العنوان">
          ...
          <div className="add-captain-container-right">
            ...
            <FormAnt.Item label="كلمة المرور">
            ...
            {/* <FormAnt.Item label="صورة الهوية">
